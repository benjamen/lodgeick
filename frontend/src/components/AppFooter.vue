      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div class="lg:col-span-1">
          <div class="flex items-center gap-3 mb-4">
            ...
            <span class="text-2xl font-bold text-white">Lodgeick</span>
          </div>
          <p class="text-gray-400 mb-6 leading-relaxed">
            One-click integration platform that connects your favorite apps and automates your workflows.
          </p>
          ...
          <div class="flex items-center gap-4">
            <a
              ...
              :key="social.name"
              :href="social.url"
              class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:text-blue-500 hover:bg-gray-700 transition-all duration-200"
      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-8 py-6">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
          <p class="text-sm text-gray-500">
            © {{ currentYear }} Lodgeick. All rights reserved.
          </p>
          <div class="flex items-center gap-6 text-sm">
            <a href="#" class="hover:text-blue-500 transition-colors">Status</a>
            <a href="#" class="hover:text-blue-500 transition-colors">API Docs</a>
            <a href="#" class="hover:text-blue-500 transition-colors">Support</a>
          </div>
        </div>
      </div>
    </div>
...
const productLinks = [
  ...
  { name: 'Integrations', to: '/account/integrations' },
